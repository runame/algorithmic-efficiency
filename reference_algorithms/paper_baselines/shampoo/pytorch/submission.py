"""Submission file for a Shampoo optimizer with warmup+cosine LR in PyTorch."""
...
from paper_baselines.shampoo.pytorch.distributed_shampoo import DistributedShampoo
